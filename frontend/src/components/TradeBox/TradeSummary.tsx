...
const TradeSummary = ({
  ...
  return (
    <Accordion defaultExpanded={true} elevation={0} sx={{ width: '100%', position: 'relative' }}>
      <AccordionSummary expandIcon={<ExpandMoreIcon sx={{ width: '2em' }} color='primary' />}>
        ...
        >
          ...
          <Tooltip enterTouchDelay={250} title={t('Save trade summary as file')}>
            <span>
              ...
              >
                <DownloadIcon sx={{ width: '1em', height: '1em' }} />
              </IconButton>
            </span>
          </Tooltip>
        </div>

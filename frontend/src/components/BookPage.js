    ...
    return (
      <div style={{ height: 422, width: '100%' }}>
        <DataGrid
          ...
          rows={this.props.bookOrders
            .filter((order) => order.type == this.props.type || this.props.type == 2)
                    ...
                    <ListItemAvatar>
                      ...
                      >
                        <Badge
                          ...
                          overlap='circular'
                          badgeContent=''
                          color={this.statusBadgeColor(params.row.robot_status)}
                        >
                          <Badge
                            overlap='circular'
      ...
      <Grid className='orderBook' container spacing={1} sx={{ minWidth: 400 }}>
        ...
        {this.props.bookNotFound ? (
          ...
          <Grid item xs={12} align='center'>
            <Typography component='h5' variant='h5'>
              {this.props.type == 0
                ? t('You are SELLING BTC for {{currencyCode}}', {
                    currencyCode: this.props.bookCurrencyCode,
                  })
                : this.props.type == 1
                ? t('You are BUYING BTC for {{currencyCode}}', {
                    currencyCode: this.props.bookCurrencyCode,
                  })

...
*Limits: in Robosats v0.1.0 kann ein Angebot nicht kleiner als 10.000 Satoshis sein ubd es kann nicht größer als 500.000 Satoshis sein, um Fehler beim weiterleiten der Lightning-Zahlung zu vermeiden. Dieses Limit wird in Zukunft erhöht werden.

...
No caso de esse cenário, faça backup do token privado do seu robô e verifique o pagamento do seu pedido de tempos em tempos". Se o problema persistir, não hesite em entrar em contato com o [grupo de suporte no SimpleX](/contribute/code/#communication-channels) para que a equipe do RoboSats possa investigar.
